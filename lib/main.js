...
if ( global.__electron_profile__ ) {
  const pkgJson = require('../package.json');
  console.warn(`A different version of electron-profile already running in the process: ${pkgJson.version}, redirect to it. Please make sure your dependencies use the same version of electron-profile.`);
  module.exports = global.__electron_profile__;
